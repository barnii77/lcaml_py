...
class Function(AstRelated, Resolvable):
    ...
    def to_python(self):
        ...
        if COMPILE_WITH_CONTEXT_LEAKING:
            body_block = (
                "_fbdac8190a62965e6098f1dc = _c86b7937662977a6928abbbc().copy()\n"  # globals intermediate save
                "for k, v in _ad7aaf167f237a94dc2c3ad2.items(): _c86b7937662977a6928abbbc()[k] = v\n"  # shadow globals
                + body_block
                + "_c86b7937662977a6928abbbc().clear()\n"
                "for k, v in _fbdac8190a62965e6098f1dc.items(): _c86b7937662977a6928abbbc()[k] = v\n"  # reconstruct previous context
            )
        function_def = (
            f"def {name}("
