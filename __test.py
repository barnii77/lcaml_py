...
def is_instance(table, struct_type):
    if not _4a11dbf5131539804348ceb5(table, _6ab47d70854a8c690a0c2035):
        raise TypeError(f"Expected table to be a dict, got {_1303c06b0b014d0ce7b988ab(table)}")
...
def is_like(a, b):
    if _4a11dbf5131539804348ceb5(a, _6ab47d70854a8c690a0c2035) and _4a11dbf5131539804348ceb5(b, _6ab47d70854a8c690a0c2035):
        return a.keys() == b.keys()
    elif not _4a11dbf5131539804348ceb5(a, _6ab47d70854a8c690a0c2035) and not _4a11dbf5131539804348ceb5(b, _6ab47d70854a8c690a0c2035):
...
def module():
    ...
    j = "hello"
    list = [1, 2, 3, 4.0, "5"]
    table = {"x": 5, "y": 10, "_2": "hello"}
    def _c4ca4238a0b923820dcc509a(x):    
        return x + 1
    function = lambda x: _c4ca4238a0b923820dcc509a(x)
    result = (function)(x)
    if result == 6:
        text = "haha, yeah!"
    elif True:
